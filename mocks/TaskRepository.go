...
// ListTask provides a mock function with given fields: ctx
func (_m *TaskRepository) ListTask(ctx context.Context) ([]*entities.Task, error) {
	ret := _m.Called(ctx)

	var r0 []*entities.Task
	if rf, ok := ret.Get(0).(func(context.Context) []*entities.Task); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*entities.Task)
